...
;;; VILBUR: CUSTOM TRAY TOOLTIP BY VARIATION			
global $tooltip := RegExReplace( A_ScriptName, "\.(ahk|exe)$", "" )
;    CONFIGURATIONS 
   ...
   If A_Is64bitOS
   {
      IF (A_PtrSize = 4)
      {
         IF A_IsCompiled
         {
            ...
            ScriptPath64 := A_ScriptDir . "\" . ScriptNoExtension . "64." . ScriptExtension ;" ;;; Fix string color
...
SuspendOn()
{
   global g_ScriptTitle
   Suspend, On
   Menu, Tray, Tip, %$tooltip% (Inactive)
   If A_IsCompiled
   {
