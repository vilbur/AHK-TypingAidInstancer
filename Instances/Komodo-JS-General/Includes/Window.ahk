...
/* INCLUDE MODIFIED FILE BY VILBUR, DISABLE FUNCTION CheckForActive() IN THIS FILE
   PATH IS FROM \TypingAidInstancer\Instances\{InsanceName}\Includes\Window.ahk, NOT FROM INSTALL DIRECTORY
*/
#Include %A_LineFile%\..\Window_extends.ahk
